...
## Languages Supported
This extension includes translations for 8 languages:
- English (en)
- Spanish (es)
- Hungarian (hu)
- Japanese (ja)
...
## Version History
See the Credits section in the extension options page for the complete changelog.

## License
This extension is distributed as open source. Please respect the original authors' work.
